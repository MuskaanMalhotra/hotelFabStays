...
const TestimonialSlider = () => {
  ...
  const testimonials = [
    ...
    {
      id: 3,
      text: "We celebrated our anniversary here and couldn't be happier. The romantic dinner setup on the beach was magical. Staff remembered all our preferences from our previous stay.",
  ...
  return (
    <div className="w-full mx-auto py-5 px-4">
      ...
      <div 
        className="relative overflow-hidden w-4/5 py-5 mx-auto bg-gray-100"
        ref={containerRef}
          ...
          {testimonials.map((testimonial) => (
            ...
            >
              <div className="relative mb-8">
                ...
                <p className="text-center text-gray-700 text-xl max-w-3xl mx-auto relative z-10 px-8">
                  {testimonial.text}
                </p>
