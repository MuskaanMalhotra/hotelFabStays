...
const Header = () => {
  ...
  return (
    <div className='relative flex justify-between items-center px-5 sm:px-28 sm:py-4 py-2 shadow-xl bg-white'>
        <div className='flex items-center gap-2'>
          <Image className='h-15 w-15' src={"/logo.png"} width={1000} height={1000} alt='logo'/>
          <h1 className='text-xl whitespace-nowrap sm:text-4xl font-serif font-extralight'>Hotel Fab Stays</h1>
        </div>
        <div className='hidden sm:flex gap-5 text-2xl font-light'>
        ...
        <div className='flex sm:hidden cursor-pointer' onClick={()=>setOpen(!open)}>
