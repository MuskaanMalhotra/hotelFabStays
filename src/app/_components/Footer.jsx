...
const Footer = () => {
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row">
        {/* map */}
      <div className="relative lg:w-2/4 h-[40vh] overflow-hidden">
        {isClient && (
          <iframe
            width="100%"
            height="600"
      ...
      <div className=" flex flex-col lg:items-center items-start justify-center lg:w-1/4 bg-[#cdb97c] p-5">
        <div className="flex flex-col lg:gap-5 gap-2 items-start justify-center">
          <div className="flex gap-5 items-end">
            ...
            <p className="lg:text-4xl text-2xl font-medium">Contact Us</p>
          </div>
      ...
      <div className=" flex flex-col lg:items-center items-start justify-center lg:w-1/4 p-5 bg-[#cdb15c]">
        <div className="flex flex-col lg:gap-5 gap-2 items-start justify-center">
          <div className="flex gap-5 items-end">
            ...
            <p className="lg:text-4xl text-2xl font-medium">Mail Us</p>
          </div>
          <div className=" flex flex-col">
    ...
    <div className="lg:p-10 p-5 flex flex-col lg:flex-row justify-between items-start gap-10 lg:gap-0 bg-[#cdb97c]">
